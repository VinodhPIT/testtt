...
useEffect(()=>{
  ...
  return (
    <>
      <Head>
        <title>
        Explore a variety of unique tattoo styles and trends
        </title>
        <meta
          name="description"
          content="Dive into a world of tattoo artistry with our diverse collection of unique tattoo styles and tattoo trends. Find your tattoo inspiration"
        />
        <meta
          name="keywords"
          content="Tattoo, Tattoo, Tattoo booking, Tattoo styles, Tattoo Designs, Tattooing, Tattoo Flash, Tattooers, Tattoo app, Tattoo lovers, Tattoos, Finleine Tattoo, Blackwork Tattoo, Traditional Tattoo, Tattoo Search, Tattoo Finder, "
        />
      </Head>
              ...
              <div className={styles.banner_item}>
                <div className={styles.banner}>
                  <div className={styles.banner_inner}>
                    ...
                    <Image
                      src={
                        "/pexels-ryan-hiebendahl-9801666-28-styleguide-M.png"
                      }
                      alt="pexels"
                      fill
                      blurDataURL={blurDataURL}
                ...
                <div className={styles.banner_content}>
                  <div
                    className={`${styles.banner_content_wrap} ${styles.text_center}`}
                  >
                    <div className={styles.banner_caption}>
                      <h1 class="color_yellow m_m_auto m_mxw_200">
                        <span>{t("common:styleGuidePage.bannerContent1")}</span>
                      </h1>
                      <h5>{t("common:styleGuidePage.bannerContent2")}</h5>
                    </div>
                    <ul className="download_app mt_0 m_mt_50 d_mxw_325 style_guide_down">
                      ...
                      <li>
                        <Link href={APP_LINK_GOOGLE} target="_blank">
                          <img src="/g-play-new.svg" alt="Playstore" />
                        </Link>
                      </li>
                    </ul>
                  </div>
          ...
          <section className="img_text_banner_box">
            <div className="col_full">
              <div className="img_text_box_wrapper">
                  ...
                  <div class="img_text_box_inner">
                    <div class="img_box_wrap block_bg_gradient_1">
                      <div class="box_text_img_over color_yellow md_max_75">
                        <h2 class="color_yellow">
                          <span class="small">
                            {t("common:styleGuidePage.title1")}{" "}
                          </span>
                          {t("common:styleGuidePage.title1-Sub")}
                        </h2>
                      </div>
                      <Image
                        priority={true}
                        src="/pexels-ademola-style-guide-D.png"
                        alt="pexels-ademola"
                        width={720}
                        height={620}
                        placeholder="blur"
                      ...
                      <Image
                        priority={true}
                        src="/pexels-ademola-style-guide-M.png"
                        alt="pexels-ademola"
                        width={720}
                        height={620}
                        placeholder="blur"
                    ...
                    <div class="text_box_content text_center no-space-center no_space_center">
                      ...
                      <div class="text_box_content_inner pr_0">
                        <h2>
                          <span> {t("common:styleGuidePage.title2")} </span>
                          <span className="textBlock">
                            {" "}
                            {t("common:styleGuidePage.title2-Sub")}{" "}
                          </span>
                        </h2>
                      </div>
                    </div>
                ...
                <div class="text_box_wrap right block_bg_orange">
                  <div class="img_text_box_inner m_switcher">
                    <div class="text_box_content text_center no-space-center no_space_center">
                      ...
                      <div class="text_box_content_inner pr_0">
                        <h2 class="color_black_h">
                          <span>{t("common:styleGuidePage.title3")} </span>
                          <span className="textBlock">
                            {t("common:styleGuidePage.title3-Sub")}{" "}
                          </span>
                        </h2>
                      </div>
                    </div>
                    <div class="img_box_wrap block_bg_gradient_1 justify_content_right img-btm-7pc">
                      ...
                      <Image
                        priority={true}
                        src="/pexels-ozan-çulha-15020597 45-fineline.png"
                        alt="pexels-ademola"
                        width={720}
                        height={620}
                        placeholder="blur"
                  ...
                  <div class="img_text_box_inner">
                    ...
                    {!isMobileView ? (
                      <div class="img_box_wrap">
                        <ul class="app_download_img_list mt_mb_6pc after_none align_item_center">
                          <li>
                            <img
                              src="/Sytlepage1.png"
                ...
                <div class="text_box_wrap left block_bg_green_100">
                  <div class="img_text_box_inner">
                    <div class="img_box_wrap block_bg_gradient_1">
                      <div class="box_text_img_over md_max_75">
                        <h2 class="color_green_100">
                          <span class="small">
                            {t("common:styleGuidePage.title5")}{" "}
                          </span>
                          {t("common:styleGuidePage.title5-Sub")}
                        </h2>
                      </div>
                      <Image
                        priority={true}
                        src="/pexels-elena-rubtsova-12301327-4-realistic.png"
                        alt="pexels-ademola"
                        width={600}
                        height={730}
                        placeholder="blur"
                ...
                <div class="text_box_wrap right block_bg_aero_blue">
                  <div class="img_text_box_inner m_switcher">
                    <div class="text_box_content text_center no_space_center">
                      ...
                      <div class="text_box_content_inner pr_0">
                        <h2 class="color_black_h">
                          <span>{t("common:styleGuidePage.title6")}</span>
                          <span className="textBlock">
                            {t("common:styleGuidePage.title6-Sub")}
                          </span>
                        </h2>
                      </div>
                    </div>
                    <div class="img_box_wrap block_bg_gradient_1 justify_content_right img-btm-7pc">
                      ...
                      <Image
                        priority={true}
                        src="/pexels-ralph-rabago-3214805-6-traditional.png"
                        alt="pexels-ademola"
                        width={720}
                        height={620}
                        placeholder="blur"
