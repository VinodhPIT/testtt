  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Tattoo, Tattoo artist,  Tattoo booking,  Tattoo images,  Tattoo styles,  Tattoo Business, Tattoo Designs, Tattooing, Tattoo Flash, Tattoo Shop, Tattoo Installments, Tattooers, Tattoo app, Tattoo lovers, Tattoos, Tattoo"
        />
      </Head>
            ...
            <div className="col_full">
              <div className="img_text_box_wrapper">
                  ...
                  <div class="img_text_box_inner">
                    <div class="text_box_content justify_content_start">
                      <div class="text_box_content_inner m_pr_0">
                        <h2>
                          <span>{t("common:homePage.title1")}</span>
                          <span className="textBlock">
                            {t("common:homePage.title1-Sub1")}
                          </span>
                          <span className="textBlock">
                            {t("common:homePage.title1-Sub2")}
                          </span>
                        </h2>
                    ...
                    <div class="img_box_wrap">
                      ...
                      <Image
                        priority
                        src="/pexels-djordje-petrovic-1433270 18-M.png"
                        alt="Picture of the author"
                        width={500}
                        height={800}
                        placeholder="blur"
                  ...
                  <div class="img_text_box_inner">
                    <div class="img_box_wrap block_bg_gradient_1 m_min_h_425">
                      ...
                      <div class="box_text_img_over color_pink">
                        <h2 class="txt_mob_fs50">
                          <span>{t("common:homePage.title2")}</span>{" "}
                          <span className="textBlock">
                            {t("common:homePage.title2-Sub")}
                          </span>
                        </h2>
                      </div>
                      <img
                      ...
                      />
                      <img
                        src="/pexels-cottonbro-studio-5320148 8-M.png"
                        alt=""
                        className="desk_hidden"
                      />
                    </div>
                    <div class="text_box_content justify_content_start">
                      ...
                      <div class="text_box_content_inner m_pr_0 pr_0">
                        <h2>
                          <span> {t("common:homePage.title3")}</span>
                          <span className="textBlock">
                            {" "}
                            {t("common:homePage.title3-Sub")}
                          </span>
                        </h2>
                    ...
                    <div className="img_text_box_inner">
                      <div className="text_box_content justify_content_start pl_0 pr_2_pc  m_pb_0">
                        <div className="text_box_content_inner m_pr_0">
                          <h2>
                            {" "}
                            <span>{t("common:homePage.title4")}</span>{" "}
                            <span className="textBlock">
                              {t("common:homePage.title4-Sub")}
                            </span>
                          </h2>
                  ...
                  <div class="img_text_box_inner">
                    <div class="img_box_wrap block_bg_gradient_1">
                      <div class="box_text_img_over color_yellow md_max_75">
                        <h2 class="color_yellow">
                          <span class="small">
                            {t("common:homePage.title7")}{" "}
                          </span>
                          {t("common:homePage.title7-Sub")}
                        </h2>
                      </div>

                      <Image
                        priority={true}
                        src="/pexels-ademola-home-D.png"
                        alt="pexels-ademola"
                        width={719}
                        height={628}
                        placeholder="blur"
                    ...
                    <div class="text_box_content">
                      ...
                      <div class="text_box_content_inner w_100pc pr_0">
                        <h2>
                          <span> {t("common:homePage.title8")}</span>
                          <span className="textBlock">
                            {" "}
                            {t("common:homePage.title8-Sub")}
                          </span>
                        </h2>
                        <Link
                          href="/styleguide"
                ...
                <div class="text_box_wrap right block_bg_black">
                  <div class="img_text_box_inner m_switcher">
                    <div class="text_box_content justify_content_start">
                      <div class="text_box_content_inner m_pr_0 pr_0">
                        <h2>
                          <span>{t("common:homePage.title5")}</span>
                          <span className="textBlock">
                            {t("common:homePage.title5-Sub1")}
                          </span>
                          <span>{t("common:homePage.title5-Sub2")}</span>
                        </h2>
                ...
                <div
                  className={
                    !isMobileView
                      ? "text_box_wrap right app_download_box_wrap block_bg_orange down_home-right-spc"
                      : "text_box_wrap right app_download_box_wrap block_bg_orange_mob down_home-right-spc"
                  }
                >
                  <div class="img_text_box_inner">
                    <div class="text_box_content justify_content_start">
                      <div class="text_box_content_inner m_pr_0 m_m_auto">
                    ...
                    {!isMobileView ? (
                      <div class="img_box_wrap">
                        <ul class="app_download_img_list img_box_img_m20pc justify_content_end slider_resize d_slid_resize">
                          <li>
                            <Image
                              src="/Home1.png"
                              width={196}
                  ...
                  {isMobileView ? (
                    <ImageSlider
                      imagePaths={["/Home1.png", "/Home2.png", "/Home3.png"]}
