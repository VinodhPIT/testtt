...
import FindT from "@/landingComponents-2/findTattoos/findT";
...
export default function Landing2() {
  return (
    <div>
      ...
      <PartnerTattoos
        mainTitle={"Partner Tattoos - A Symbol of Everlasting Love"}
        content1={
        ...
        tattooContent3={
          "Your partner tattoo becomes a timeless reminder of the precious moments you've shared."
        }   
      />
      <FindT
        title="Find the tattoos with the right meaning for you"
        button="Find tattoos now"
        img1="/zodiac-sign-01.png"
        img2="/zodiac-sign-02.png"
      />
      <TrendingArtist />
